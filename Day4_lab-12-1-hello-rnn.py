...
X = tf.placeholder(
    tf.float32, [None, sequence_length, input_dim])  # X one-hot, batch size 는 None으로 둠
Y = tf.placeholder(tf.int32, [None, sequence_length])  # Y label

# 1. 우선 Cell을 만드는데, LSTM, RNN, GRU 다양하게 만들수 있음
# Cell Size는 5
...
# cost function으로 sequence_loss 함수를 사용
# 슬라이드 내용 추가해서 설명!
# weight : 각 자리를 얼마나 중요하게 볼거냐
