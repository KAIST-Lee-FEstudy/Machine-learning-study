...
from lab_char_rnn_utils import TextLoader

# 설정 값
data_dir = 'lab_char_rnn_data/tinyshakespeare' # 셰익스피어 희곡 <리처드 3세> 데이터로 학습
...
# https://code.i-harness.com/ko/q/2141556
...
# gradient가 너무 커져서 Overshooting 되는 경우를 막기 위해 해줌
