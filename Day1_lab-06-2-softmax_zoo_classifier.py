...
Y_one_hot = tf.one_hot(Y, nb_classes)  # one hot encoding 해줌 (shape=(?,1,7))
print("one_hot", Y_one_hot)

# tf.one_hot은 1차원을 늘리기 때문에 reshape을 통해 1차원을 다시 줄여줘야함
...
# TF에서 제공하는 softmax_cross_entropy_with_logits 함수를 이용해서 cost를 구성
