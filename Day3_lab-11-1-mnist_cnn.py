...
# Convolution -> Subsampling -> Fully Connected Network
...
X_img = tf.reshape(X, [-1, 28, 28, 1])   # img 28x28x1 (black/white) 로 reshape
...
#    Conv     -> (?, 28, 28, 32)
#    Pool     -> (?, 14, 14, 32)
# 출력값은 입력의 이미지와 같도록 만들어줌 (stride =1 )
L1 = tf.nn.conv2d(X_img, W1, strides=[1, 1, 1, 1], padding='SAME')
# 나온 결과 값을 ReLU를 통과시키고 맥스 풀링을 함
# 사이즈가 1/2로 됨
L1 = tf.nn.relu(L1)
